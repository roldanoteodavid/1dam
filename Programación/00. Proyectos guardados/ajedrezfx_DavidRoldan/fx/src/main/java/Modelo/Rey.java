...
public class Rey extends Pieza {
    ...
    public Image toImage() {
        ...
        if (Rey.super.getColor().equals("negro"))
            image = new Image("File:fx/src/main/resources/com/example/imagenes/ReyNegro.png");
        else
            image = new Image("File:fx/src/main/resources/com/example/imagenes/ReyBlanco.png");
        return image;
    }
