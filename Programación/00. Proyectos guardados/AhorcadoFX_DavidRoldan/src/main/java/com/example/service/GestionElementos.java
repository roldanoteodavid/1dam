...
public class GestionElementos implements IGestionElementos {
    ...
    public GestionElementos(List<Elemento> elementos) {
        this.daoElementos = new DaoElementosImplementacion(elementos);
    }

    public GestionElementos(Elementos elementos) {
        this.daoElementos = new DaoElementosImplementacion(elementos);
    }
    ...
    public Elemento getElementoNivelCategoria(int dificultad, String categoria) throws CatLevException, CategoriaException {
        return daoElementos.getElementoNivelCategoria(dificultad, categoria);
    }
    ...
    public boolean escribirFichero() {
        return daoElementos.escribirFichero();
    }

    @Override
    public boolean escribirFicheroBinario() {
        DaoElementosFicheros.cargarFicheroBinario();
        return false;
    }
